...
clear;
stacksize('max');
path = "/media/data/evo/robotics_report/ros_packages/youbot_arm_control/calculations/data_for_identification/";

for l = 1:10
    
    xi = path + "bigs/big_xi" + string(l) + ".txt";
    tau = path + "bigs/big_tau" + string(l) + ".txt";
