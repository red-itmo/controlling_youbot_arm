...
class XI:
	...
	def opL0(self):
		...
		a, d = self.a, self.d
		opL_0 = -a[0]*(-a[0]*ddq[1] + d[0]*sin(q[0])*ddq[0] + d[0]*cos(q[0])*dq[0]**2)
		return opL_0
	...
	def opL1(self):
		...
		q, dq, ddq = self.q, self.dq, self.ddq
		a, d = self.a, self.d
		opL_1 = 2*a[0]*ddq[1] - d[0]*sin(q[0])*ddq[0] - d[0]*cos(q[0])*dq[0]**2
		return opL_1
	...
	def opL3(self):
		...
		q, dq, ddq = self.q, self.dq, self.ddq
		a, d = self.a, self.d
		opL_3 = -d[0]*(sin(q[0])*dq[0]**2 - cos(q[0])*ddq[0])
		return opL_3
	...
	def opL7(self):
		...
		q, dq, ddq = self.q, self.dq, self.ddq
		a, d = self.a, self.d
		opL_7 = sin(q[0])*ddq[0] + cos(q[0])*dq[0]**2
		return opL_7
	...
	def opL9(self):
		...
		q, dq, ddq = self.q, self.dq, self.ddq
		a, d = self.a, self.d
		opL_9 = sin(q[0])*dq[0]**2 - cos(q[0])*ddq[0]
		return opL_9
